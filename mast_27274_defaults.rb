...
######################################
# Defaults for namelist theta_grid_gridgen_knobs
#######################################
...
@abort_rapid_time_step_change = ".false." #Set whether error occurs for time step changing too rapidly. False bet					    ter since will quit only of too small
...
@local_field_solve = ".true." # Strongly affects initialization time on some parallel computers.
...
@use_le_layout = ".true."       # Use new LE layout for collisions
...
######################################
# Defaults for namelist testgridgen
#######################################
