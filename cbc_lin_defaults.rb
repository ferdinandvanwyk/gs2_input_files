...
@naky = 4    # The number of ky modes: the number of ky modes actually simulated (naky) is equal to (ny - 1)/3 + 1, due to the need to prevent aliasing.
...
@aky_max = 3.0		# Upper limit of ky range
...
@delt = 0.01    # Time step
@nstep = 100    # Maximum number of timesteps
...
@nwrite_new = 50    # Output diagnostic data every nwrite
